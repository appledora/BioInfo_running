...
with open("R1.fastq", "rU") as f1, open("R2.fastq", "rU") as f2:
    lines1 = []
    lines2 = []
...
for i in range(len(read1)):
    ...
    accuracy_ga = (((len(alignments[0][0]) - (indelCount+subCount))/ len(alignments[0][0]))*100)
