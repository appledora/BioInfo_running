...
def collapse(read1, read2, reg1, reg2, qpos1, qpos2, qq1, qq2, substring, qep1, qep2):
    ...
    for i in range(len(qScore_region_R1)):
        if reg1[i] != reg2[i]:
...
with open("ERR346600_1.fastq", "rU") as f1, open("ERR346600_1.fastq", "rU") as f2:
    lines1 = []
    lines2 = []
...
for i in range(len(read1)):
    ...
    region_r1 = firstDNA[headpos_R1:headpos_R1 +
                         len(head_r1)+len(substring) + len(tail_r1)]
    # print(headpos_R2, "----", headpos_R2 +
    #       len(head_r2) + len(substring) + len(tail_r2))
    # print(len(head_r1), "===", len(head_r2))
    # print(len(head_r1), "===", len(head_r2))
    # print(firstDNA,"\n",r)
    ...
    # print(finalRead)
    finalGARead = collapse_ga(firstDNA,r,region_r1,region_r2,qual1,qual2,alignments[0][0],alignments[0][1],pos1,pos2)
    # print(finalGARead)
